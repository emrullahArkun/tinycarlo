...
class TinyCarloEnv(gym.Env):
    ...
    def __get_info(self) -> Dict[str, Any]:
        ...
        return {"cte": cte, "heading_error": heading_error, "position": self.car.position.copy(), "orientation": self.car.rotation, "laneline_distances": distances, "local_path": local_path}
